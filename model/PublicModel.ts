...
export default class extends mysql implements PublicModelInterface{
    ...
    insert(TabelName: string, ArrData: any = [], insertMore?: boolean, showSqlStr?: boolean, indexMore?: number, indexMaxMore?: number, parentData: any = [], keyNameMap:any = null): this {
        if(Object.prototype.toString.call(TabelName) === "[object Object]"){
            ArrData = TabelName;
            TabelName = null;
        }
        return super.insert(TabelName || this.$TableName, ArrData, insertMore, showSqlStr, indexMore, indexMaxMore, parentData, keyNameMap);
    }
}
