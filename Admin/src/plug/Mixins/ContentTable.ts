...
// @ts-ignore
import {pageConfig} from "../../../src/data/ComponentsConfig";
// @ts-ignore
import otherApi, {windowCommon, WindowCommonAxiosRequestConfig} from "../../../src/api/Interface";
...
interface ContentTable extends vue{
    ...
    init_currentPagination_pageNo(bool:boolean):Promise<any>;
    _ContentTable_pagination_getTableData(pageNo:number):void;
